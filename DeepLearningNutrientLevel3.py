...
training_Y_1 = r"C:\Users\ahmed\Documents\Machine Learning\Projects\Simple Project 1 - NN Logistic Regression for Plant Deficiency\NitrogenDeficiencyImage\Training\swap3"
...
test_Y_1 = r"C:\Users\ahmed\Documents\Machine Learning\Projects\Simple Project 1 - NN Logistic Regression for Plant Deficiency\NitrogenDeficiencyImage\Test\swap3"
...
def L_layer_model(X, Y, layer_dims, learning_rate, num_iterations = 3000, print_cost = True):
    ...
    for i in range(0, 1100):
        ...
        if print_cost and i % 100 == 0 or i == num_iterations - 1:
            ...
            costs.append(cost)
    for i in range(1100, num_iterations):
        AL, caches = L_model_forward(X, parameters)
        cost = compute_cost(AL, Y)
        grads = L_model_backward(AL, Y, caches)
...
# 82% at 0.005 (1100), 0.001 (1200)

import csv
with open('Level3.csv', 'w', newline='') as file:
