...
training_Y_1 = r"C:\Users\ahmed\Documents\Machine Learning\Projects\Simple Project 1 - NN Logistic Regression for Plant Deficiency\NitrogenDeficiencyImage\Training\swap4"
...
training2_Y_0 = r"C:\Users\ahmed\Documents\Machine Learning\Projects\Simple Project 1 - NN Logistic Regression for Plant Deficiency\NitrogenDeficiencyImage\Training\swap2"
training3_Y_0 = r"C:\Users\ahmed\Documents\Machine Learning\Projects\Simple Project 1 - NN Logistic Regression for Plant Deficiency\NitrogenDeficiencyImage\Training\swap3"

test_Y_1 = r"C:\Users\ahmed\Documents\Machine Learning\Projects\Simple Project 1 - NN Logistic Regression for Plant Deficiency\NitrogenDeficiencyImage\Test\swap4"
...
test2_Y_0 = r"C:\Users\ahmed\Documents\Machine Learning\Projects\Simple Project 1 - NN Logistic Regression for Plant Deficiency\NitrogenDeficiencyImage\Test\swap2"
test3_Y_0 = r"C:\Users\ahmed\Documents\Machine Learning\Projects\Simple Project 1 - NN Logistic Regression for Plant Deficiency\NitrogenDeficiencyImage\Test\swap3"
...
hiden_layer_dims = np.ones((1)).astype(int) * 5 # (30,) element array containing number of nodes for each hidden layer
output_layer_dims = np.array([1]) # number of output nodes
layer_dims = np.concatenate((input_layer, hiden_layer_dims, output_layer_dims), axis = 0)
...
parameters, costs = L_layer_model(X_train_flatten, Y_train, layer_dims, learning_rate = 0.01, num_iterations = 5700, print_cost = True)
...
#peaked at 5700: 0.07016
# Could lower learning_rate, and increase num_iterations to improve results

import csv
with open('Level4.csv', 'w', newline='') as file:
